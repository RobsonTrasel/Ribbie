import { Parser, ParserModifier, ParserModifierFactory, ParserState } from './model'
import { updateParserError, updateParserState } from './parserUtil'
...
const transform =
  ...
  export default {
    maybeSome, maybe, atLeastOne, repeat,transform,
  };